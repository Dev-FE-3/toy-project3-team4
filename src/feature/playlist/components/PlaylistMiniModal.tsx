...
const PlaylistMiniModal = () => {
  ...
  return (
    <div
      ...
      className="fixed bottom-[60px] z-40 flex cursor-pointer items-center justify-between border-t bg-white px-4 py-3 shadow-inner"
    >
      <div>
        <p className="text-xs text-gray-400">다음</p>
        <p className="w-[380px] truncate text-sm font-semibold">{nextVideo?.title || '다음 영상 없음'}</p>
      </div>
