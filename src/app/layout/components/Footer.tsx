...
const Footer = () => {
  ...
  return (
    <nav className="fixed bottom-0 mx-auto flex h-[56px] w-[430px] items-center justify-center gap-10 border-t border-gray-light-medium bg-basic-white px-[15px] py-[8px]">
      <NavItem path="/" menu="홈" icon="home" />
      <NavItem path="/팔로잉" menu="팔로잉" icon="following" />
      {/* 영상추가 */}
